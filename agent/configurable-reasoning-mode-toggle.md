# Configurable Reasoning Mode Toggle
...
## Problem
Agent LLM responses are either always verbose with chain-of-thought (slow, expensive) or always terse (low accuracy on complex tasks) — no runtime control over reasoning depth
