...
**Observed in:** [hf:nex-agi/Nex-N2-Pro](https://huggingface.co/nex-agi/Nex-N2-Pro)
**Compatible with:** python, typescript, any

## Problem
Agent wastes tokens and latency doing deep chain-of-thought reasoning on trivial sub-steps, but also shallow-reasons on critical decisions that need careful planning—no mechanism to calibrate thinking depth per action
