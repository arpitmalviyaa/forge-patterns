# Filesystem-Native Agent Context

**Category:** agent
**Confidence:** production-proven
**Observed in:** [nexu-io/open-design](https://github.com/nexu-io/open-design)
**Compatible with:** python, typescript, any, claude-code, openclaw

## Problem
AI agents lack persistent, structured context about project constraints (brand rules, design tokens, domain vocabulary, workflow steps) so each invocation starts cold and produces inconsistent outputs
