# Configurable Reasoning Toggle Pattern

**Category:** agent
**Confidence:** production-proven
**Observed in:** [hf:nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16](https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Ultra-550B-A55B-BF16)
**Compatible with:** python, typescript, any

## Problem
LLM responses are either always verbose with chain-of-thought traces (slow, expensive) or always terse (low accuracy on complex tasks) — no runtime control over reasoning depth
