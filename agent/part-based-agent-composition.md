# Part-Based Agent Composition

**Category:** agent
**Confidence:** production-proven
**Observed in:** [steve02081504/fount](https://github.com/steve02081504/fount)
**Compatible with:** python, typescript, any

## Problem
Agent logic becomes a monolithic blob: prompts, tools, memory, persona, and UI all tangled together making it impossible to swap components, test in isolation, or let users customize behavior without touching core code
