# SKILL: Tiered Reasoning Budget Agent

Use this pattern when: LLM inference costs spiral unpredictably when every agentic call uses maximum reasoning depth, or quality degrades when you cheaply route everything through a fast model with no depth control
