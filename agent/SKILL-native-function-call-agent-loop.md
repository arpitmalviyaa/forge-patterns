# SKILL: Native Function-Call Agent Loop

Use this pattern when: LLM agents require complex glue code to parse tool calls, handle multi-turn agentic loops, and integrate structured outputs — brittle prompt engineering breaks when model versions change
