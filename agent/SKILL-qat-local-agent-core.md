# SKILL: QAT Local Agent Core

Use this pattern when: Running capable LLM agents locally or on cheap infra is blocked by VRAM/cost constraints, forcing dependence on expensive API calls for every agentic step including function-calling and legal document reasoning
...
## Reference
[hf:unsloth/gemma-4-12B-it-qat-GGUF](https://huggingface.co/unsloth/gemma-4-12B-it-qat-GGUF)
