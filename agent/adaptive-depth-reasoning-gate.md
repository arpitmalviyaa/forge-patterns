# Adaptive Depth Reasoning Gate

**Category:** agent
**Confidence:** production-proven
**Observed in:** [hf:nex-agi/Nex-N2-mini](https://huggingface.co/nex-agi/Nex-N2-mini)
**Compatible with:** python, typescript, any

## Problem
Agent wastes tokens doing deep chain-of-thought on trivial steps, or conversely rushes critical decisions without sufficient reasoning, causing either high latency or poor task reliability in long-horizon workflows
