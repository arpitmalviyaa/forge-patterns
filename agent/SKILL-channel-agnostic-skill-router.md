# SKILL: Channel-Agnostic Skill Router

Use this pattern when: Agent logic gets tangled with delivery channel specifics — you write separate handlers for Slack, Telegram, WhatsApp and the business logic duplicates or diverges across each, making skills hard to test and reuse
