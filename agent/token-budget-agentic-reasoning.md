# Token-Budget Agentic Reasoning

**Category:** agent
**Confidence:** production-proven
**Observed in:** [hf:moonshotai/Kimi-K2.7-Code](https://huggingface.co/moonshotai/Kimi-K2.7-Code)
**Compatible with:** python, typescript, any

## Problem
Agentic LLM loops burn excessive tokens on internal chain-of-thought, making multi-step legal-doc or code tasks prohibitively expensive and slow at inference time
