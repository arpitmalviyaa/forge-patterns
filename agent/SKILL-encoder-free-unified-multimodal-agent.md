# SKILL: Encoder-Free Unified Multimodal Agent

Use this pattern when: Multimodal pipelines become brittle and slow when separate vision/audio encoders must be coordinated before reaching the LLM, adding latency, memory overhead, and separate fine-tuning passes for each modality
