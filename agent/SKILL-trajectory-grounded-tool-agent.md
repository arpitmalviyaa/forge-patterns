# SKILL: Trajectory-Grounded Tool Agent

Use this pattern when: LLM agents fail at multi-turn tool orchestration because they lack training on realistic tool-call/feedback loops, causing hallucinated tool signatures, broken retry logic, and shallow reasoning between steps
...
## Reference
[hf:Jackrong/Qwopus3.6-27B-Coder-MTP-GGUF](https://huggingface.co/Jackrong/Qwopus3.6-27B-Coder-MTP-GGUF)
