# SKILL: Skill File Agent Bootstrap

Use this pattern when: AI agents don't know how to use a new tool or API without lengthy system prompt engineering or manual configuration — onboarding friction kills automation pipelines
