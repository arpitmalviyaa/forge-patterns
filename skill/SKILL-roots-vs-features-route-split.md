# SKILL: Roots vs Features Route Split

Use this pattern when: SPA route files bloat with business logic, hooks, and UI components causing tangled navigation trees that are hard to test, refactor, or reuse across desktop/mobile/popup build targets
