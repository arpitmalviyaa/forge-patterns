# SKILL: Dual Shortcut Context Injection

Use this pattern when: Agent sessions lose track of relevant files, prior knowledge, and available tools because context must be manually re-pasted each turn, bloating prompts and breaking flow for power users who switch between tasks
...
## Reference
[MatrixAges/polywise](https://github.com/MatrixAges/polywise)
