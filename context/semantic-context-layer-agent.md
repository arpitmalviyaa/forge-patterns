# Semantic Context Layer Agent

**Category:** context
**Confidence:** production-proven
**Observed in:** [Canner/WrenAI](https://github.com/Canner/WrenAI)
**Compatible with:** python, any, claude-code

## Problem
AI agents querying your database return wrong or hallucinated results because they only see raw schemas with no business meaning, relationships, or domain vocabulary — the agent doesn't know that 'ARR' means annual recurring revenue or that 'active_cases' excludes archived records
