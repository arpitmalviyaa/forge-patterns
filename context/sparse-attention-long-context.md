...
**Observed in:** [hf:MiniMaxAI/MiniMax-M3](https://huggingface.co/MiniMaxAI/MiniMax-M3)
**Compatible with:** python, any

## Problem
Processing long legal documents (contracts, case files, regulatory texts) exhausts memory and compute—full attention over 1M tokens is quadratically expensive and practically unusable in a single inference pass
