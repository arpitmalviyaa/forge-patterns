# SKILL: MCP Tool Gateway Pattern

Use this pattern when: AI agents need to perform real-world actions (web scraping, search, page interaction) but have no standardized way to call external services, leading to bespoke brittle integrations per LLM client
