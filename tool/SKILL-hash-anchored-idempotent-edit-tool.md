# SKILL: Hash-Anchored Idempotent Edit Tool

Use this pattern when: LLM-generated file edits fail silently or apply to wrong location when file has changed since read, causing corrupt diffs, wrong replacements, and wasted retry loops that burn tokens and break agent reliability
