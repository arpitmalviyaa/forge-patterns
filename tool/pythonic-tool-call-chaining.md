# Pythonic Tool Call Chaining

**Category:** tool
**Confidence:** production-proven
**Observed in:** [hf:LiquidAI/LFM2.5-8B-A1B](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B)
**Compatible with:** python, any

## Problem
LLM agents struggle to reliably chain multiple tool calls in sequence, producing malformed JSON or losing context between calls
