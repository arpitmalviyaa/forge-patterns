...
Use this pattern when: LLM inference is too slow and memory-hungry for production legal-doc processing; loading a full dense model for every request wastes compute on irrelevant parameters
