# SKILL: QAT GGUF Local Inference

Use this pattern when: Capable LLM with native function-calling is too large to run locally or on modest cloud hardware, blocking agentic workflows without expensive GPU instances
...
## Reference
[hf:unsloth/gemma-4-26B-A4B-it-qat-GGUF](https://huggingface.co/unsloth/gemma-4-26B-A4B-it-qat-GGUF)
