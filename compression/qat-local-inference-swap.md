# QAT Local Inference Swap

**Category:** compression
**Confidence:** production-proven
**Observed in:** [hf:google/gemma-4-12B-it-qat-q4_0-gguf](https://huggingface.co/google/gemma-4-12B-it-qat-q4_0-gguf)
**Compatible with:** python, typescript, any

## Problem
Cloud LLM API costs scale with usage, latency spikes under load, and sensitive legal data cannot be sent to third-party endpoints
