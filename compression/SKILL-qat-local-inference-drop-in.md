# SKILL: QAT Local Inference Drop-in

Use this pattern when: Running a capable 12B+ instruction-tuned LLM locally or on a cheap VPS is blocked by VRAM/RAM ceiling; full bfloat16 weights are too large for indie-scale infra
