# SKILL: Client-Token Namespace Isolation

Use this pattern when: Multi-tenant AI tools leak user data between sessions, require auth infrastructure, or expose private uploads in shared storage — a critical compliance risk in legal-tech where document confidentiality is non-negotiable
...
## Reference
[hf:build-small-hackathon/her](https://huggingface.co/spaces/build-small-hackathon/her)
