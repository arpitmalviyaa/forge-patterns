# SKILL: Encoder-Free Multimodal Fusion

Use this pattern when: Multimodal pipelines (text + image + audio) require orchestrating multiple separate encoder models, increasing latency, deployment complexity, memory footprint, and making end-to-end fine-tuning across modalities impractical
...
## Reference
[hf:google/gemma-4-12B-it](https://huggingface.co/google/gemma-4-12B-it)
