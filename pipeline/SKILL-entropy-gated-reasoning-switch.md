# SKILL: Entropy-Gated Reasoning Switch

Use this pattern when: LLM agent wastes tokens on verbose chain-of-thought for easy steps, yet under-thinks hard steps, causing both cost blowout and accuracy failures in the same workflow
...
## Reference
[hf:prefeitura-rio/Rio-3.5-Open-397B](https://huggingface.co/prefeitura-rio/Rio-3.5-Open-397B)
