# SKILL: Async Job Queue Polling

Use this pattern when: Long-running AI tasks (podcast generation, document processing, embeddings) block HTTP responses and cause timeouts or poor UX when handled synchronously
