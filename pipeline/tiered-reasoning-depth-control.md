# Tiered Reasoning Depth Control
...
## Problem
LLM inference costs spike unpredictably because all requests use maximum reasoning regardless of task complexity, making agentic pipelines expensive and slow for simple subtasks
