# SKILL: Streamed Think Block Parsing

Use this pattern when: Agent outputs lack transparency; users cannot audit reasoning steps; debugging multi-step legal logic is opaque
