# Workflow Pipeline Memory Harness

**Category:** pipeline
**Confidence:** production-proven
**Observed in:** [NevaMind-AI/memU](https://github.com/NevaMind-AI/memU)
**Compatible with:** python, any

## Problem
Agent context windows bloat with raw conversation history, documents, and repeated facts causing high token costs and stale context; no structured way to persist, retrieve, and compress memories across sessions
