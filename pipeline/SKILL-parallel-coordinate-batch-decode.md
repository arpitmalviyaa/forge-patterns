# SKILL: Parallel Coordinate Batch Decode

Use this pattern when: Autoregressive token-by-token decoding of structured outputs (bounding boxes, clause spans, date ranges, entity coordinates) creates serial bottlenecks—each token waits for the previous, multiplying latency by the number of tokens in the structure
...
## Reference
[hf:nvidia/LocateAnything-3B](https://huggingface.co/nvidia/LocateAnything-3B)
